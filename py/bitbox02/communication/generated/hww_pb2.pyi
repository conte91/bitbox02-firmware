...
from .common_pb2 import (
    CancelRequest as common_pb2___CancelRequest,
    PubResponse as common_pb2___PubResponse,
    RootFingerprintRequest as common_pb2___RootFingerprintRequest,
    RootFingerprintResponse as common_pb2___RootFingerprintResponse,
)
...
class Request(google___protobuf___message___Message):
    ...
    @property
    def fingerprint(self) -> common_pb2___RootFingerprintRequest: ...

    @property
    def cancel(self) -> common_pb2___CancelRequest: ...
    ...
    def __init__(self,
        *,
        ...
        fingerprint : typing___Optional[common_pb2___RootFingerprintRequest] = None,
        cancel : typing___Optional[common_pb2___CancelRequest] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"bitboxbase",u"btc_pub",u"btc_sign_init",u"btc_sign_input",u"btc_sign_output",u"cancel",u"check_backup",u"check_sdcard",u"create_backup",u"device_info",u"device_language",u"device_name",u"eth",u"fingerprint",u"insert_remove_sdcard",u"list_backups",u"perform_attestation",u"random_number",u"reboot",u"request",u"reset",u"restore_backup",u"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",u"set_password",u"show_mnemonic"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"bitboxbase",u"btc_pub",u"btc_sign_init",u"btc_sign_input",u"btc_sign_output",u"cancel",u"check_backup",u"check_sdcard",u"create_backup",u"device_info",u"device_language",u"device_name",u"eth",u"fingerprint",u"insert_remove_sdcard",u"list_backups",u"perform_attestation",u"random_number",u"reboot",u"request",u"reset",u"restore_backup",u"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",u"set_password",u"show_mnemonic"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"bitboxbase",b"bitboxbase",u"btc_pub",b"btc_pub",u"btc_sign_init",b"btc_sign_init",u"btc_sign_input",b"btc_sign_input",u"btc_sign_output",b"btc_sign_output",u"cancel",b"cancel",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"create_backup",b"create_backup",u"device_info",b"device_info",u"device_language",b"device_language",u"device_name",b"device_name",u"eth",b"eth",u"fingerprint",b"fingerprint",u"insert_remove_sdcard",b"insert_remove_sdcard",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"random_number",b"random_number",u"reboot",b"reboot",u"request",b"request",u"reset",b"reset",u"restore_backup",b"restore_backup",u"restore_from_mnemonic",b"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",b"set_mnemonic_passphrase_enabled",u"set_password",b"set_password",u"show_mnemonic",b"show_mnemonic"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"bitboxbase",b"bitboxbase",u"btc_pub",b"btc_pub",u"btc_sign_init",b"btc_sign_init",u"btc_sign_input",b"btc_sign_input",u"btc_sign_output",b"btc_sign_output",u"cancel",b"cancel",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"create_backup",b"create_backup",u"device_info",b"device_info",u"device_language",b"device_language",u"device_name",b"device_name",u"eth",b"eth",u"fingerprint",b"fingerprint",u"insert_remove_sdcard",b"insert_remove_sdcard",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"random_number",b"random_number",u"reboot",b"reboot",u"request",b"request",u"reset",b"reset",u"restore_backup",b"restore_backup",u"restore_from_mnemonic",b"restore_from_mnemonic",u"set_mnemonic_passphrase_enabled",b"set_mnemonic_passphrase_enabled",u"set_password",b"set_password",u"show_mnemonic",b"show_mnemonic"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"request",b"request"]) -> typing_extensions___Literal["random_number","device_name","device_language","device_info","set_password","create_backup","show_mnemonic","btc_pub","btc_sign_init","btc_sign_input","btc_sign_output","insert_remove_sdcard","check_sdcard","set_mnemonic_passphrase_enabled","list_backups","restore_backup","perform_attestation","reboot","check_backup","eth","reset","restore_from_mnemonic","bitboxbase","fingerprint","cancel"]: ...
...
class Response(google___protobuf___message___Message):
    ...
    @property
    def fingerprint(self) -> common_pb2___RootFingerprintResponse: ...
    ...
    def __init__(self,
        *,
        ...
        fingerprint : typing___Optional[common_pb2___RootFingerprintResponse] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"btc_sign_next",u"check_backup",u"check_sdcard",u"device_info",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"random_number",u"response",u"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc_sign_next",u"check_backup",u"check_sdcard",u"device_info",u"error",u"eth",u"fingerprint",u"list_backups",u"perform_attestation",u"pub",u"random_number",u"response",u"success"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"btc_sign_next",b"btc_sign_next",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"device_info",b"device_info",u"error",b"error",u"eth",b"eth",u"fingerprint",b"fingerprint",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"pub",b"pub",u"random_number",b"random_number",u"response",b"response",u"success",b"success"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"btc_sign_next",b"btc_sign_next",u"check_backup",b"check_backup",u"check_sdcard",b"check_sdcard",u"device_info",b"device_info",u"error",b"error",u"eth",b"eth",u"fingerprint",b"fingerprint",u"list_backups",b"list_backups",u"perform_attestation",b"perform_attestation",u"pub",b"pub",u"random_number",b"random_number",u"response",b"response",u"success",b"success"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"response",b"response"]) -> typing_extensions___Literal["success","error","random_number","device_info","pub","btc_sign_next","list_backups","check_backup","perform_attestation","check_sdcard","eth","fingerprint"]: ...
