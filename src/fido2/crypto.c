...
#include "device.h"
// stuff for SHA512
#include <crypto/cifra/src/sha2.h>
#include <crypto/cifra/src/blockwise.h>
//#include APP_CONFIG
//#include "log.h"
...
{
    solo_sha256_update(&sha256_ctx, data, len);
}
...
{
    solo_sha256_update(&sha256_ctx, master_secret, 32);
}

void crypto_sha256_final(uint8_t * hash)
{
    solo_sha256_final(&sha256_ctx, hash);
}
