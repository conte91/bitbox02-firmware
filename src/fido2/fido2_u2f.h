...
/**
 * This file contains duplicates of the definitions contained in <u2f/u2f.h>.
 * TODO: remove this and match the existing definitions to the ones in <u2f/u2f.h>.
 */
#ifndef _FIDO2_U2F_H_
