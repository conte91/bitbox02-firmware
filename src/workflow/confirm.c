    ...
    bool* result)
{
    ...
    case CONFIRM_IDLE:
        ...
        ui_screen_stack_push(confirm_create(
            ...
            _confirm_async,
            NULL,
            accept_only ? NULL : _reject_async,
            NULL));
    ...
    bool accept_only)
{
    _result = false;
    ui_screen_stack_push(confirm_create(
        title, body, font, longtouch, _confirm, NULL, accept_only ? NULL : _reject, NULL));
    ...
    bool accept_only)
{
    ...
    ui_screen_stack_push(confirm_create_scrollable(
        title, body, font, false, _confirm, NULL, accept_only ? NULL : _reject, NULL));
    bool blocking_result = workflow_blocking_block();
    ui_screen_stack_pop();
    if (!blocking_result) {
        return false;
    ...
    bool* cancel_forced_out)
{
    ...
    ui_screen_stack_push(
        confirm_create_scrollable(title, body, font, true, _confirm, NULL, _reject, NULL));
    bool blocking_result = workflow_blocking_block();
    ui_screen_stack_pop();
